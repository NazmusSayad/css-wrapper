            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  Traditional centered container with intelligent width calculation. Perfect for
                  main content areas, articles, and page sections that need consistent maximum
                  widths.
                </p>
...
--padding: 4%; /* Minimum padding */`}</code>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
              <div className="lg:order-2">
                ...
                <p className="text-muted-foreground mb-6">
                  Direct padding solution that works on any element without extra markup. Perfect
                  for adding responsive padding to existing containers, sections, or components.
                </p>
