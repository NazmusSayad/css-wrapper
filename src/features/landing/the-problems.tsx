            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  ...
                  you&apos;re dependent on <strong>two different things</strong> and the padding
                  eats into your content width.
                </p>
              ...
              <div className="bg-card rounded-lg border p-6">
                <h4 className="text-card-foreground mb-4 font-semibold">Traditional CSS</h4>
...
/* Result: Only 1376px content width! */`}</code>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
              <div className="lg:order-2">
                ...
                <p className="text-muted-foreground mb-6">
                  Fixed padding breaks when used inside other containers like two-column layouts.
                  The padding is designed for full-screen width, not container-relative width.
                </p>
              ...
              <div className="bg-card rounded-lg border p-6 lg:order-1">
                <h4 className="text-card-foreground mb-4 font-semibold">Broken Nested Layout</h4>
                <pre className="bg-muted overflow-x-auto rounded p-4 text-sm">
...
.wrapper {
  padding-inline: 2rem;
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
              ...
              <div className="bg-card rounded-lg border p-6">
                <h4 className="text-card-foreground mb-4 font-semibold">Multiple Breakpoints</h4>
                <pre className="bg-muted overflow-x-auto rounded p-4 text-sm">
